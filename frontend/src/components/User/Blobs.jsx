  ...
  const Modal = ({ blob, onClose }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600/50">
        <div className="relative w-full max-w-3xl p-6 mx-4 bg-white rounded-lg shadow-xl max-h-[90vh] overflow-y-auto border border-green-100"  style={{ scrollbarWidth: 'none' }}>
          <button
            onClick={onClose}
